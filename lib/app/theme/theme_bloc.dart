...
import 'package:my_bloc_advanced/infrastructure/storage/local_storage.dart';

import '../../core/logging/app_logger.dart';
import '../../shared/design_system/theme/app_theme_palette.dart';
...
class ThemeBloc extends Bloc<ThemeEvent, ThemeState> {
  static final _log = AppLogger.getLogger("ThemeBloc");
  ...
  FutureOr<void> _onLoadTheme(LoadTheme event, Emitter<ThemeState> emit) async {
    try {
